...
class LocalizedTests {
    ...
    fun ar_arabic() {
        ...
        assertThat(HumanReadable.duration(1.seconds)).isEqualTo("1 ثانية")
        assertThat(HumanReadable.duration(2.seconds)).isEqualTo("2 ثانية")
        ...
        assertThat(HumanReadable.timeAgo(twoSecondsAgo, baseInstant = now)).isEqualTo("قبل 2 ثانية")
        assertThat(HumanReadable.timeAgo(oneMinuteFromNow, baseInstant = now)).isEqualTo("بعد 1 دقيقة")
        assertThat(HumanReadable.duration(3.days)).isEqualTo("3 أيام")
        assertThat(HumanReadable.duration(twoMonths)).isEqualTo("2 شهر")
        assertThat(HumanReadable.duration(oneYear)).isEqualTo("1 سنة")
