...
internal val KkStrings = HumanReadableStrings(
    dateTime = DateTimeStrings(
        ...
        seconds = multipleTenses { present(one = "секунд", other = "секунд"); future(one = "секундтан", other = "секундтан") },
        minutes = multipleTenses { present(one = "минут", other = "минут"); future(one = "минуттан", other = "минуттан") },
        hours = multipleTenses { present(one = "сағат", other = "сағат"); future(one = "сағаттан", other = "сағаттан") },
