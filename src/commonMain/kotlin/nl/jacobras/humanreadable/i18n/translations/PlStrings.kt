...
internal val PlStrings = HumanReadableStrings(
    dateTime = DateTimeStrings(
        ...
        hoursShort = presentTense(one = "godz."),
        daysShort = presentTense(one = "dz."),
        weeksShort = presentTense(one = "tydz."),
        monthsShort = presentTense(one = "mies."),
        yearsShort = presentTense(one = "r."),
        secondsNarrow = presentTense(one = "s"),
        minutesNarrow = presentTense(one = "min"),
        hoursNarrow = presentTense(one = "g"),
