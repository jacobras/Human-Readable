...
internal val UkStrings = HumanReadableStrings(
    dateTime = DateTimeStrings(
        ...
        minutesShort = presentTense(one = "хв"),
        hoursShort = presentTense(one = "год"),
        daysShort = presentTense(one = "дн"),
        weeksShort = presentTense(one = "тиж"),
        monthsShort = presentTense(one = "міс"),
        yearsShort = presentTense(one = "р"),
        secondsNarrow = presentTense(one = "с"),
        minutesNarrow = presentTense(one = "хв"),
        hoursNarrow = presentTense(one = "год"),
        daysNarrow = presentTense(one = "д"),
        weeksNarrow = presentTense(one = "т"),
        monthsNarrow = presentTense(one = "м"),
        yearsNarrow = presentTense(one = "р"),
        timeAgo = { "$it тому" },
